function [eph_GPS,obs_GPS,nr_sv_excl] = Preliminary_Check_GAL(eph_GPS,obs_GPS,x0)
%
...
if ~isempty(obs_GPS)
    ...
    %rejection old eph
    eph_GPS=eph_GPS(:,abs(eph_GPS(3,:)-t_obs)<=max_time_propagation_GPS);
    ...
    if nr_sv_GPS1>0
        ...
        [position_ecef]=orbital_propagator_GAL0(eph_GPS,t_obs);
        ...
        %eph_GPS = eph_GPS(:,ismember(eph_GPS(1,:),obs_GPS(:,1)));
